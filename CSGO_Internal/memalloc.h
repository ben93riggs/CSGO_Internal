...
public:
	...
	{
		typedef void*(__thiscall* oAlloc)(void*, size_t);
		return CallVFunction<oAlloc>(this, 1)(this, nSize);
	}

	void* Realloc(void *pMem, size_t nSize)
	{
		typedef void*(__thiscall* oRealloc)(void*, void*, size_t);
		return CallVFunction<oRealloc>(this, 3)(this, pMem, nSize);
	}

	void Free(void* pMem)
	{
		typedef void(__thiscall* oFree)(void*, void*);
		return CallVFunction<oFree>(this, 5)(this, pMem);
	}

//	// Release versions
//	virtual void *Alloc(size_t nSize) = 0; //1
//	virtual void dummy() = 0;
//	virtual void *Realloc(void *pMem, size_t nSize) = 0; //3
