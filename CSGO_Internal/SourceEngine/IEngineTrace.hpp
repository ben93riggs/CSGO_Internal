...
#define   PHYSICS_MULTIPLAYER_SOLID		0x1
...
#pragma endregion
	...
	{
	public:
		CTraceFilter(): pSkip(nullptr)
		{
		}

		explicit CTraceFilter(IHandleEntity* skip)
		{
			pSkip = skip;
		}
	...
	class CTraceFilterPlayer : public ITraceFilter
	{
	public:
		CTraceFilterPlayer() : pHit(nullptr)
		{
		}

		explicit CTraceFilterPlayer(IHandleEntity* hit)
		{
			pHit = hit;
		}
	...
	class CTraceFilterSkipTwoEntities2 : public CTraceFilter
	{
	public:
		CTraceFilterSkipTwoEntities2(IHandleEntity *pPassEnt1, IHandleEntity *pPassEnt2, int collisionGroup) {
			pSkip = pPassEnt1;
			pSkip2 = pPassEnt2;
	...
	public:
		...
		IHandleEntity *passentity1;
		IHandleEntity *passentity2;
	};
