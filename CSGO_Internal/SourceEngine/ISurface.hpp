...
#include <d3d9.h>
     ...
     public:
		  ...
		  virtual bool        SetFontGlyphSet(HFont font, const char *windowsFontName, int tall, int weight, int blur, int scanlines, FontFlags flags, int nRangeMin = 0, int nRangeMax = 0) = 0;
          ...
          virtual void        PlaySound2(const char *fileName) = 0;
     ...
     }; //extern ISurface * g_pSurfaceHook;
