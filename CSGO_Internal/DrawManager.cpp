...
//}
//void DrawManager::RenderRect(DWORD color, int x, int y, int w, int h) const
//{
...
//          float curPointX = x + r * cos(2 * PI * i / resolution);
//          float curPointY = y - r * sin(2 * PI * i / resolution);
//          if(i > 0) {
...
//          rect.left++;
//          m_pDefaultFont->DrawTextA(nullptr, buffer, -1, &rect, DT_TOP | DT_LEFT | DT_NOCLIP, 0xFF000000);
//          rect.top++;
//          m_pDefaultFont->DrawTextA(nullptr, buffer, -1, &rect, DT_TOP | DT_LEFT | DT_NOCLIP, 0xFF000000);
//     };
//
//     if(centered) {
//          RECT rec = {0,0,0,0};
//          m_pDefaultFont->DrawTextA(nullptr, buffer, -1, &rec, DT_CALCRECT | DT_NOCLIP, color);
//          rec = {x - rec.right / 2, y, 0, 0};
//
//          drawShadow(rec);
//          m_pDefaultFont->DrawTextA(nullptr, buffer, -1, &rec, DT_TOP | DT_LEFT | DT_NOCLIP, color);
//
//     } else {
